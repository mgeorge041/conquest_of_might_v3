...
public abstract class CardPieceDisplay : CardDisplay, IPointerClickHandler
{
    ...
    // Create test card piece display
    public static CardPieceDisplay LoadTestCardUnitDisplay() {
        Transform testTransform = new GameObject().transform;
        CardPieceDisplay testCardPieceDisplay = (CardPieceDisplay)Card.Initialize(Card.LoadTestUnitCard(), testTransform);
        return testCardPieceDisplay;
    }
